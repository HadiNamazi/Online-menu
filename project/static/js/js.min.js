...
function loginPopup() {
    Swal.fire({
        ...
        html: '<div class="form-group"><label asp-for="PhoneNo"><\/label><div class="input-group text-center" dir="ltr"><div class="input-group-prepend" ><span class="input-group-text" id="basic-addon98" style="border-radius:  0.25rem 0 0 0.25rem  !important">+98<\/span><\/div><input type="text" id="PhonNo" maxlength="10" asp-for="PhoneNo" class="form-control" placeholder="912 xxx xx xx" required=""  autocomplete="off" onkeyup="zeroRemove()" style="border-radius: 0 0.25rem 0.25rem 0 !important"><\/div><span asp-validation-for="PhoneNo" class="text-danger"><\/span><\/div>',
        showCancelButton: !0,
        cancelButtonText: "رد کردن",
        ...
        if (n.value) {
            ...
            $.ajax({
                ...
                success: function(n) {
                    n.success ? Swal({
                        type: "info",
                        text: `لطفا کد ارسال شده به شماره ${t.PhoneNo} را وارد کنید`,
                        input: "text",
                        inputAttributes: {
                            autocapitalize: "off",
                            id: "activeCode",
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/Account/SmsConfirmCodePopUp",
                            data: JSON.stringify(t),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function(n) {
                                n.success ? ($.cookie("IsRegistrationRequired", !0, {
                                    expires: 180,
                                    path: "/"
                                }),
                                window.location.reload()) : Swal({
                                    type: "error",
                                    text: n.responseText,
                                    showConfirmButton: !1,
                                    timer: 2500
            ...
            $.cookie("IsRegistrationRequired", !0, {
                expires: 180,
                path: "/"
            })
    }
...
function handleCustomeMenu(n) {
    ...
    $("#addressFooter").text(n.Address);
    $("#addressFooter").attr("href", `https://maps.google.com/?q=${n.Latitude},${n.Longitude}`);
    ...
    n.Facebook != null && ($("#facebookId").removeClass("d-none"),
    $("#facebookId").attr("href", "https://www.facebook.com/" + n.Facebook));
    n.Twitter != null && ($("#twitterId").removeClass("d-none"),
    $("#twitterId").attr("href", "https://twitter.com/" + n.Twitter));
    n.Instagram != null && ($("#instagramId").removeClass("d-none"),
    $("#instagramId").attr("href", "https://www.instagram.com/" + n.Instagram),
    $("#instagramHeader").attr("href", "https://www.instagram.com/" + n.Instagram),
    $("#instagramHeader2").attr("href", "https://www.instagram.com/" + n.Instagram));
    n.Latitude !== "35.6993751" && ($("#mapLatLang").removeClass("d-none"),
    $("#mapLatLang").attr("href", `https://maps.google.com/?q=${n.Latitude},${n.Longitude}`));
    n.Whatsapp != null && ($("#whatsappId").removeClass("d-none"),
    $("#whatsappId").attr("href", "https://wa.me/" + n.Whatsapp));
    n.Telegram != null && ($("#telegramId").removeClass("d-none"),
    $("#telegramId").attr("href", "https://t.me/" + n.Telegram));
    n.IsActiveTranslate === !0 && ($("#translateLogo").removeClass("d-none"),
    n.IsShowFirstViewTranslatePopup === !0 && $.cookie("IsShowFirstViewTranslatePopup") != "Yes" && (viewLanguage(),
    $.cookie("IsShowFirstViewTranslatePopup", "Yes", {
        expires: 1e3
    })));
    n.IsActiveFeedback === !0 && n.IsActiveCreateFeedback === !0 && ($("#feedBackBt").removeClass("d-none"),
    setTimeout(function() {
    ...
    n.IsActiveCallWaiter === !0 && ($("#callWaiter").removeClass("d-none"),
    $("#callWaiterBt").removeClass("d-none"),
    setTimeout(function() {
...
function iOS_version() {
    if (userAgent.match(/ipad|iphone|ipod/i)) {
        var n = {};
        return n.User_Agent = userAgent,
        n.As_Reported = userAgent.match(/OS (\d)?\d_\d(_\d)?/i)[0],
        n.Major_Release = userAgent.match(/OS (\d)?\d_\d(_\d)?/i)[0].split("_")[0],
        n.Full_Release = userAgent.match(/OS (\d)?\d_\d(_\d)?/i)[0].replace(/_/g, "."),
        n.Major_Release_Numeric = +userAgent.match(/OS (\d)?\d_\d(_\d)?/i)[0].split("_")[0].replace("OS ", ""),
        n.Full_Release_Numeric = +userAgent.match(/OS (\d)?\d_\d(_\d)?/i)[0].replace("_", ".").replace("_", "").replace("OS ", ""),
        n
    }
}
...
function calCount(n, t, i, r) {
    return i !== "deleteOtherBranch" ? parseInt($("#lblCountBasket-" + n).text()) + t > 0 ? ($("#btnMinus-" + n).removeClass("d-none"),
    $("#lblCountBasket-" + n).removeClass("d-none"),
    $("#btnPlusIcon-" + n).removeClass("fas"),
    $("#btnPlusIcon-" + n).addClass("far"),
    r ? $("#cardImageFooter-" + n).addClass("lgSelectableImageCard") : $("#cardItem-" + n).addClass("lgSelectableCard"),
    i === "viewItem" && ($("#btnMinusM-" + n).removeClass("d-none"),
    $("#lblCountBasketM-" + n).removeClass("d-none"),
    $("#btnPlusIconM-" + n).removeClass("fas"),
    $("#btnPlusIconM-" + n).addClass("far")),
    parseInt($("#lblCountBasket-" + n).text()) + t) : ($("#btnMinus-" + n).addClass("d-none"),
    $("#lblCountBasket-" + n).addClass("d-none"),
    $("#btnPlusIcon-" + n).addClass("fas"),
    $("#btnPlusIcon-" + n).removeClass("far"),
    r ? $("#cardImageFooter-" + n).removeClass("lgSelectableImageCard") : $("#cardItem-" + n).removeClass("lgSelectableCard"),
    i === "viewItem" && ($("#btnMinusM-" + n).addClass("d-none"),
    $("#lblCountBasketM-" + n).addClass("d-none"),
    $("#btnPlusIconM-" + n).addClass("fas"),
    $("#btnPlusIconM-" + n).removeClass("far")),
    parseInt($("#lblCountBasket-" + n).text()) + t) : 0
}
function viewItem(n) {
    $.ajax({
...
function bannerModelShow(n) {
    ...
    $("#modalSpinner").addClass("d-none");
    $("#contentSpinner").removeClass("d-none");
    $(".modal-content").css("width", "unset");
    $("#modalBody").html(`<button class="btn btn-default default-shadow  bottom-right mybtn  position-fixed active" data-dismiss="modal" aria-label="Close"><span class="fa fa-times fa-lg"></span></button><img class="img-fluid" src="/UploadImage/${$.cookie("collectionCode") + "/" + n}" style="width:100% !important">`)
}
function handleViewItem(n) {
    ...
    settingMenu.IsSalesOfProductSubsets ? $.cookie("IsIncludeSubsets-" + n) === "isSubsets" ? $.ajax({
        ...
        success: function(i) {
            let r = new Date;
            i.success ? (r.setTime(r.getTime() + 9e5),
            $.cookie("IsIncludeSubsets-" + n, "isSubsets", {
                expires: r
            }),
            $.ajax({
                url: `/Menu/SubsetsMenuItem?itemId=${n}&menuId=${$.cookie("menuId")}&collectionCode=${t.collectionCode}`,
            ...
            $.cookie("IsIncludeSubsets-" + n, "notSubsets", {
                expires: r
            }),
            viewItem(t))
        }
...
function AfterIsSuccessAddToCard(n) {
    $.ajax({
        ...
        success: function(t) {
            ...
            n.ref === "foodNoteModal" && (console.log(window.location.pathname),
            window.location.pathname.includes("ViewCart") ? ($("#exampleModal").modal("hide"),
            location.href = `/Order/ViewCart/${$.cookie("menuId")}`) : $("#exampleModal").modal("hide"));
            n.ref === "viewCard" && (location.href = `/Order/ViewCart/${$.cookie("menuId")}`)
        }
    })
}
function AddToCardAll(n) {
    var i = [], t = $.cookie("uniqId"), r;
    (t === null || t == undefined) && (t = uuidv4(),
    $.cookie("uniqId", t, {
        expires: 360,
        path: "/"
    }));
    ...
    n.fa2x ? ($(n.element).prop("disabled", !0),
    $(n.element).html(`<div class="spinner-border mb-1"></div>`)) : ($(n.element).prop("disabled", !0),
    $(n.element).html(`<div class="spinner-border spinner-border-sm mb-1"></div>`));
    $.ajax({
        type: "POST",
        url: "/Order/AddToCart",
        contentType: "application/json; charset=utf-8",
        ...
        success: function(i) {
            if (i.success)
                return $(n.element).html(n.beforeHtml),
                $(n.element).prop("disabled", !1),
                AfterIsSuccessAddToCard(n),
                !0;
            i.handleExeption === 1 ? ($(n.element).html(n.beforeHtml),
            $(n.element).prop("disabled", !1),
            Swal.fire({
                type: "error",
...
function FoodNoteManager(n) {
    $.ajax({
        ...
        success: function(t) {
            let i = new Date;
            t.success && n.count !== -1 ? ($("#exampleModal").modal(),
            $("#modalSpinner").removeClass("d-none"),
            $("#contentSpinner").addClass("d-none"),
            $(".modal-dialog").addClass("modal-dialog-centered"),
            i.setTime(i.getTime() + 9e5),
            $.cookie("IsIncludeFoodNote-" + n.itemId, "isInclude", {
                expires: i
            }),
            $.ajax({
...
function SalesOfProductSubsets(n) {
    $.ajax({
        ...
        success: function(t) {
            let i = new Date;
            t.success ? ($("#exampleModal").modal(),
            $("#modalSpinner").removeClass("d-none"),
            $("#contentSpinner").addClass("d-none"),
            $(".modal-dialog").addClass("modal-dialog-centered"),
            i.setTime(i.getTime() + 9e5),
            $.cookie("IsIncludeSubsets-" + n.itemId, "isSubsets", {
                expires: i
            }),
            $.ajax({
...
function ShowFeedBack() {
    settingMenu.IsActiveCreateFeedback && settingMenu.IsActiveFeedback && ($("#feedBackBt").removeClass("d-none"),
    setTimeout(function() {
        $("#feedBackBt").removeClass("btn-35")
    }, 1e3),
    setTimeout(function() {
    ...
    $("#loadFeedBack").load("/feedback/LoadFeedBack/" + $.cookie("menuId")))
}
...
function btnGoGroup(n) {
    ...
    $("#collapsLine").hasClass("w-75") && ($("#collapsLine").removeClass("w-75"),
    $(".swiper-pagination").addClass("d-none"),
    $(".fixed-topMenuGroup").css("height", "150px"),
    swiper.destroy(),
...
function handleChangeLang(n, t) {
    $.ajax({
        ...
        success: function(n) {
            var i, r;
            n.isTranslate ? ($.cookie("isTranslate", "yes"),
            i = document.documentElement.lang,
            window.location = `#googtrans(${i}|${t})`,
            location.reload()) : ($.cookie("isTranslate", "no"),
...
userAgent.includes("Instagram") ? userAgent.match(/(\(iPod|\(iPhone|\(iPad)/) ? $("#inline_contentInsIos").removeClass("d-none") : userAgent.includes("Android") && ($("#inline_contentInsCh").removeClass("d-none"),
setTimeout(function() {
...
function(n, t, i) {
    if (i in t && t[i]) {
        var r, u = n.location, f = /^(a|html)$/i;
        n.addEventListener("click", function(n) {
            for (r = n.target; !f.test(r.nodeName); )
                r = r.parentNode;
            "href"in r && (r.href.indexOf("http") || ~r.href.indexOf(u.host)) && (n.preventDefault(),
            u.href = r.href)
        }, !1)
    }
...
$(document).ready(function() {
    if ($.cookie("isAuth") === "false" && settingCollection.IsRegistrationBeforeAddOrder === !0 && ($("#A-cardLoading").attr("href", `javascript:void(0)`),
    $("#A-cardLoading").attr("onclick", "notRegister()")),
    setTimeout(function() {
    ...
    $(window).scroll(function n() {
        ...
        $("#fixMenu").addClass("footer-tabs"),
        $("#logoHeaderDiv").removeClass("d-none")) : ($("#fixMenu").css({
            position: "relative",
            top: "auto"
        }),
        $("#fixMenu").removeClass("footer-tabs"),
        $("#logoHeaderDiv").addClass("d-none")),
        n
    }()),
    new URLSearchParams(window.location.search).get("collectionCode").toLocaleLowerCase() === "demo") {
        ...
        settingMenu.IsCheckDailyInventory && settingMenu.IsActiveSale && $.ajax({
            ...
            success: function(n) {
                n.success && $.each(n.data, function() {
                    this.isAvailable || ($("#finish-" + this.itemId).removeClass("d-none"),
                    $("#notFinish-" + this.itemId).addClass("d-none"))
                })
            }
        });
    ...
    $("#autFilter").autocomplete({
        ...
        minLength: 2,
        select: function(n, t) {
            return $("#autFilter").val(t.item.label),
            handleViewItem(t.item.value),
            btnGoItem(t.item.value),
            !1
        }
    });
...
$("#darklayout").on("click", function() {
    ...
    $("body").addClass("dark"),
    $("#darklayout").parent().addClass("active")) : ($.removeCookie("darklayout", ""),
